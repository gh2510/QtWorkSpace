...
**----------------------------------------------------------
************************************************************/
#ifndef _DDS_ParticipantTYPESUPPORT_H_INCLUDED_ 
#define _DDS_ParticipantTYPESUPPORT_H_INCLUDED_
...
#include "rtps/ParticipantAgent.h"
class DomainParticipant;

class ParticipantTypeSupport : public TypeSupport 
{
public:
    static _RETURNCODE_T Register_Type(DomainParticipant* pDomainParticipant, string strTypeName) 
    {
        ...
        try 
        {
            pNewAgent = new ParticipantAgent(pDomainParticipant, strTypeName);
        }

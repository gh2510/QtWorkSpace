#ifndef PYFLASHLISTPRIVATE_H
#define PYFLASHLISTPRIVATE_H
...
class PYFlashListPrivate : public QWidget
{
    Q_OBJECT
public:
    explicit PYFlashListPrivate(int hei,QWidget *parent = 0);

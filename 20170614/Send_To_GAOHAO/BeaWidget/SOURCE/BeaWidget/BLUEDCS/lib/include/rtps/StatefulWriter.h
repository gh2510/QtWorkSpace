...
#elif KYLIN
	pthread_mutex_t m_hProxySemMutex;
	int _sem_init_proxy_ret;
#endif
...
#elif KYLIN
	pthread_mutex_t m_hSemMsgGetMutex;
	int _sem_init_msg_ret;
#endif
...
#elif KYLIN
	pthread_mutex_t m_hSemCacheMutex;
	int _sem_init_cache_ret;
#endif
